...
export default function Agent({ userName, userId, type, interviewId,questions }: AgentProps) {
    ...
    const currentStatus = callStatus === CallStatus.INACTIVE || CallStatus.FINISHED;
            ...
            {messages.length > 0 && (
                <div className="transcript-border">
                    <div className='transcript'>
                        <p key={latestMessage} className={cn('transition-opacity duration-500 opacity opacity-0', 'animate-fade-in opacity-100')}>
                            {latestMessage}
                        </p>
                    </div>
                </div>
